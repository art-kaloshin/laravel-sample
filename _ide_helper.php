 ...
 */
    ...
    namespace Illuminate\Support\Facades {
        ...
        use Illuminate\Http\classuse Illuminate\Http\JsonResponse;
        use Illuminate\Http\Client\PendingRequest;use Illuminate\Http\Client\ResponseSequence;use Illuminate\Http\never;
        use Illuminate\Http\RedirectResponse;
        use Illuminate\Http\TEnum;
        use Illuminate\Http\UploadedFile;
        use Illuminate\Log\Logger;use Illuminate\Log\LogManager;use Illuminate\Mail\Mailer;use Illuminate\Mail\MailManager;use Illuminate\Mail\PendingMail;use Illuminate\Mail\SentMessage;use Illuminate\Notifications\ChannelManager;use Illuminate\Process\FakeProcessDescription;use Illuminate\Process\FakeProcessResult;use Illuminate\Process\FakeProcessSequence;use Illuminate\Process\InvokedProcess;use Illuminate\Process\PendingProcess;use Illuminate\Process\Pool;use Illuminate\Process\ProcessPoolResults;use Illuminate\Queue\QueueManager;use Illuminate\Queue\SyncQueue;use Illuminate\Routing\Exceptions\BackedEnumCaseNotFoundException;
        use Illuminate\Routing\Exceptions\UrlGenerationException;
        use Illuminate\Routing\PendingResourceRegistration;
        use Illuminate\Routing\PendingSingletonResourceRegistration;
        use Illuminate\Routing\Redirector;use Illuminate\Routing\ResponseFactory;
        ...
        use Illuminate\Support\DateFactory;use Illuminate\Support\HtmlString;
        use Illuminate\Support\LazyCollection;use Illuminate\Support\ServiceProvider;use Illuminate\Support\Stringable;use Illuminate\Support\Testing\Fakes\BusFake;use Illuminate\Support\Testing\Fakes\EventFake;use Illuminate\Support\Testing\Fakes\MailFake;use Illuminate\Support\Testing\Fakes\NotificationFake;use Illuminate\Support\Testing\Fakes\QueueFake;use Illuminate\Support\Timebox;use Illuminate\Translation\MessageSelector;use Illuminate\Validation\PresenceVerifierInterface;
        use Illuminate\Validation\ValidationException;
        use Illuminate\View\Compilers\BladeCompiler;use Illuminate\View\Component;use Illuminate\View\Engines\EngineResolver;
        ...
        use LogicException;
        use PDO;use PDOStatement;use Psr\Http\Message\StreamInterface;
        use Psr\Log\LoggerInterface;use Pusher\Pusher;use ReflectionException;
        use RuntimeException;
        use SessionHandlerInterface;
        use SplFileInfo;
        use stdClass;
        use Symfony\Component\Console\Command\Command;use Symfony\Component\Console\Exception\CommandNotFoundException;use Symfony\Component\Console\Input\InputInterface;use Symfony\Component\Console\Output\OutputInterface;use Symfony\Component\HttpFoundation\BinaryFileResponse;
        use Symfony\Component\HttpFoundation\callable;use Symfony\Component\HttpFoundation\ParameterBag;use Symfony\Component\HttpFoundation\StreamedResponse;
        use Symfony\Component\HttpKernel\Exception\HttpException;use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;use Symfony\Component\HttpKernel\Exception\UnauthorizedHttpException;use Symfony\Component\Mailer\Transport\TransportInterface;use Symfony\Component\Routing\Exception\RouteNotFoundException;use Symfony\Component\Translation\TranslatorInterface;use Throwable;use Traversable;use TypeError;
     ...
     */
         ...
         * @param array|string $key
         * @param TCacheValue|\Illuminate\Cache\(\Closure():  TCacheValue)  $default
     ...
     */
         ...
         *
         * @param Closure|Builder|Expression|string $table
     ...
     * @method static InvokedProcess start(array|string|null $command = null, callable $output = null)
     ...
     */
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder
                        MySqlBuilder::useNativeSchemaOperationsIfPossible($value);
        }
                    /**
     ...
     */
         ...
         * @param \Illuminate\Http\File|UploadedFile|string|array|null $file
         * @param mixed $options
         * @return string|false
         * @static
         */
...
namespace  {
    ...
    use Illuminate\Database\Query\array;
    use Illuminate\Database\Query\Builder;
    ...
    class App extends \Illuminate\Support\Facades\App {}
             ...
             *
             * @param string|array|Expression $column
             * @return Builder
             * @static
             */
